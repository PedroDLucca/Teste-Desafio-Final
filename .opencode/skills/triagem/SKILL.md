---
name: triagem
description: Move issues e PRs externos por uma máquina de estados de papéis de triagem — categorizar, verificar, entrevistar se necessário e escrever instruções prontas para agentes.
...
The maintainer invokes `/triagem` and describes what they want in natural language. Interpret the request and act. Examples:
